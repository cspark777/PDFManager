...
/////////////////////////////////////////////////////////////////////////////
// CIncludeFileTypesGridCtrl window

class CProgressItem;

class CIncludeFileTypesGridCtrl : public CBCGPGridCtrl
{
// Construction
public:
...
// Overrides
	...
	//{{AFX_VIRTUAL(CIncludeFileTypesGridCtrl)
	//}}AFX_VIRTUAL

// Implementation
public:
	virtual ~CIncludeFileTypesGridCtrl();

	// Generated message map functions
protected:
	//{{AFX_MSG(CIncludeFileTypesGridCtrl)
