// ShellContextMenu.h: Schnittstelle f? die Klasse CShellContextMenu.
//
//////////////////////////////////////////////////////////////////////
...
public:
	...
	UINT ShowContextMenu (CWnd* pWnd, CPoint pt, CMenu* inParentMenu = NULL, LPCTSTR inParentName = NULL, int inPos = 0);
	CShellContextMenu();
